...
#define TRIGGER_RIGHT  28  
#define ECHO_RIGHT     26 

#define MOTOR_DIR_BACK 6
#define MOTOR_DIR_FRONT 5
#define MOTOR_PWM 4
...
extern int laser_right, laser_center, laser_left, left_laser, right_laser;
...
extern bool stayLeft;

extern bool firstTurn;

extern bool lastColorGreen = false;
